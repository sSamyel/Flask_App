...
class TranslateForm(FlaskForm):
    ...
    lang = SelectField('Язык', choices=[('en', 'Английский'), ('it', 'Итальянский'), ('zh', 'Китайский'), ('ru', 'Русский'), ('ba', 'Белорусский'), ('ko', 'Корейский'), ('az', 'Азербайджанский'), ('sq', 'Албанский'), ('am', 'Амхарский'), ('en', 'Арабский')
